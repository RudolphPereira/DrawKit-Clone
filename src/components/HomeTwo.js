        ...
        <div className="homeTwo__bottomContent">
          ...
          <div className="homeTwo__icon--container">
            <div className="icons__imageContent">
              <div className="icon">
                <img
                  src="https://global-uploads.webflow.com/5bcb46130508ef456a7b2930/5ecf40c4ecf1c59478b050a9_consistently-style.svg"
                  alt=""
              ...
              <div className="icon">
                <img
                  src="https://global-uploads.webflow.com/5bcb46130508ef456a7b2930/5ecf41f79d8fbe95d6ded819_customisable.svg"
                  alt=""
                  className="icon__image"
                />
              </div>
              <div className="icon">
                <img
                  src="https://global-uploads.webflow.com/5bcb46130508ef456a7b2930/5ecf453d4752d36a78e5b53a_royalty%20free.svg"
                  alt=""
                  className="icon__image"
                />
              </div>
              <div className="icon">
                <img
                  src="https://global-uploads.webflow.com/5bcb46130508ef456a7b2930/5ecf45f70d06db11f4f8483a_vector.svg"
                  alt=""
                  className="icon__image"
                />
              </div>
              <div className="icon">
                <img
                  src="https://global-uploads.webflow.com/5bcb46130508ef456a7b2930/5ecf4efa08921959f55cb4ab_multiple%20styles.svg"
                  alt=""
                  className="icon__image"
                />
              </div>
